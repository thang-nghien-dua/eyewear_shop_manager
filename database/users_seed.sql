...
-- Xóa các tài khoản test cũ nếu có (để tránh trùng email)
DELETE FROM users WHERE email IN (
    ...
    'customer1@lumina.vn',
    'customer2@lumina.vn',
    -- Tài khoản demo cũ trong login.php
    'Admin1@gmail.com',
    'Manager1@gmail.com',
    'Sale1@gmail.com',
...
-- ============================================================
-- 3. SALES — Nhân viên bán hàng / hỗ trợ
-- ============================================================
INSERT INTO users (role_id, full_name, email, phone, password_hash, status, email_verified_at)
...
-- ============================================================
-- 4. OPERATIONS — Nhân viên vận hành / kho
-- ============================================================
INSERT INTO users (role_id, full_name, email, phone, password_hash, status, email_verified_at)
...
-- ============================================================
-- 5. CUSTOMER — Khách hàng thường (2 tài khoản)
-- ============================================================
